...
function Navbar(){
    ...
    <div className="bg-roxo w-full h-32 flex flex-row items-center place-content-between">
        ...
        <ul className="flex text-laranja text-3xl w-[1200] place-content-evenly fonteBold">
            <li className="navbarHover">App</li>
            <li className="navbarHover">Cartões</li>
            {/* <ul>
                <li>Cartão Standart</li>
                <li>Cartão Black</li>
            </ul> */}
            <li className="navbarHover">Benefícios</li>
            <li className="navbarHover">Moeda</li>
            <li className="navbarHover">Cultura</li>
            <li className="navbarHover">Candidatura</li>
        </ul>
    </div>
)
}
