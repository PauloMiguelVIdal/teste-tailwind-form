...
function CostasCartãoStandartLimpo() {
    const { dadosNumeroCartão } = useContext(CentraldeDadosContext);
    const { dadosNumeroCVV } = useContext(CentraldeDadosContext);
    return (
        // <div>
        //     <div className="origin-center flex justify-center items-center flex-row w-110 h-[37.5rem] bg-gradient-to-tl from-roxoForte via-roxo to-laranja rounded-[40px] ml-10">
        ...
        //             </div>
        //         </div>
        //         <div className="w-[70px] h-[600px] bg-[#c0c0c0] relative z-10 mr-[120px]"></div>
        ...
        //         </div>
        //         <h4 className="text-laranja fonteBold text-[20px] -rotate-90 relative right-[90px] top-[205px]">Standart</h4>
        //     </div>
        // </div>
        <div className=" origin-center flex justify-center items-center flex-row w-[400px] h-[600px] bg-gradient-to-tl from-roxoForte via-roxo to-laranja rounded-[40px] ml-[200px] ">

        <div>
        <div className="w-[70px] h-[600px] bg-[#c0c0c0] relative top-[184px] left-[37px]"></div>
            ...
            <h4 className="text-laranja fonteBold text-[20px] -rotate-90 relative left-[50px] bottom-[400px]">STANDART</h4>
        </div>
    </div>
    )
}

export default CostasCartãoStandartLimpo