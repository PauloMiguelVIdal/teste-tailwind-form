...
import chip from "../iconParaCartão/chip-de-cartao-de-credito (1).png"
import obcoin from "../../../Logo/OBCOIN svg.svg"
function CartãoBlack(){
    return(
        <div className="origin-center flex justify-center items-center flex-col w-110 h-[37.5rem] bg-gradient-to-br from-black from-35% to-roxoForte to-65% rounded-[40px]">
