...
function CartãoBlack(){
    return(
        <div className="origin-center flex justify-center items-center flex-col w-110 h-[37.5rem] bg-gradient-to-br from-preto from-35% to-roxoForte to-65% rounded-2xl ml-10">
