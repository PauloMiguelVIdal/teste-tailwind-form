...
function Cartão1() {
    ...
    return (
        <div className="origin-center hover:origin-center hover:rotate-12 transition-all flex justify-center items-center flex-col w-110 h-[37.5rem] bg-gradient-to-br from-roxoForte via-roxo to-laranja rounded-2xl box3 mr-10">
