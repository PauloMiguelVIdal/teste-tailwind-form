...
import CartãoBlackEStandart from "./cartãoBlackEStandart";
function TelaInicialCartão(){
    return(
       ...
       <div className="w-full h-[1024px] bg-gradient-radial from-laranja via-roxo to-roxoForte">
            <div className="h-[34rem] w-full bg-transparent">
                <Navbar></Navbar>
                <CartãoBlackEStandart></CartãoBlackEStandart>
            </div>
...
export default TelaInicialCartão